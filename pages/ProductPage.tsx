      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-4">
            ...
            >
              {product.stock > 0 ? 'Secure To Cart' : 'Asset Unavailability'}
            </button>
            <button className="p-6 border-2 border-slate-100 rounded-[2rem] hover:bg-slate-50 transition-all text-slate-300 hover:text-red-500 shadow-sm">
